  ...
  return (
    <>
      ...
      <Section title="順位の見方">
        ...
        <Question q="DNS と DNF は何が違いますか">
          <p>
            DNS はエントリーしていたものの、スタートしなかった選手です。計測記録が
            一つも出ていないことから判断しています。DNF はスタートしたあと、ゴールに
            たどり着かなかった選手です。主催者が備考欄に記録したものをそのまま読んでいます。
          </p>
          <p>
            レース中に DNS と出ている選手は、まだ最初の計測点に届いていないだけの
            可能性もあります。時間が経っても変わらなければ、スタートしなかったと考えて
            差し支えありません。
          </p>
        </Question>
        <Question q="「通過者のみ」と書かれた順位は何ですか">
          <p>
            まだ走っている途中の区間で出している順位です。その計測点を通過した人だけを
            分母に取っているので、後ろにいる人が通過するたびに分母も順位も動きます。
            走り切った人だけの順位に落ち着くのは、その区間を全員が終えてからです。
          </p>
          <p>
            走り終えていない区間のタイムは「住吉まで 2:53:05」のように、
            どこまでの記録かを添えて表示しています。区間の全長で走った記録ではありません。
          </p>
        </Question>
