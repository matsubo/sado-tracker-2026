    ...
    <>
      ...
      <Section title="外部に送られるもの">
        <Question q="アクセス解析（Google アナリティクス）">
          ...
          <p>
            ブックマークの一覧と、絞り込みに入力した名前は送っていません。
            共有リンクなどでアドレスに含まれていた場合も、取り除いてから送ります。
            ただし、選手ページのアドレスにはその選手のゼッケン番号が入るため、
            どの選手のページが開かれたかは Google に渡ります。
          </p>
          <p>
        ...
        <p className="text-[12px] opacity-90">
          ページを開いただけで閲覧者の端末から外部に出る通信は、この 2 つだけです。
