...
const ROWS: Row[] = [
  // A finisher with every checkpoint
  {
    ...
    division: "Aタイプ",
    age: "30-34歳男子",
    reception: `2026/09/05 11:54:07`,
    briefing: `2026/09/05 13:00:00`,
    waterEntry: `${D} 05:40:00`,
    start: `${D} 06:00:00`,
    passes: {
      ｽｲﾑL: [`${D} 06:40:00`, "120"],
      ｽｲﾑF: [`${D} 07:20:30`, "450"],
      ﾊﾞｲｸS: [`${D} 07:28:00`, "000"],
      住吉: [`${D} 11:20:00`, "300"],
      "ﾗﾝS（本部）": [`${D} 14:56:00`, "000"],
      ﾗﾝ4km: [`${D} 15:18:00`, "000"],
      ﾗﾝ39km: [`${D} 19:40:00`, "000"],
      FINISH: [`${D} 19:58:30`, "110"],
    },
    total: "13:58:30",
  },
  // A athlete mid-bike, past 住吉 only
  {
    ...
    division: "Aタイプ",
    age: "45-49歳女子",
    waterEntry: `${D} 05:42:00`,
    start: `${D} 06:00:00`,
    passes: {
      ｽｲﾑL: [`${D} 06:41:12`, "000"],
      ｽｲﾑF: [`${D} 07:23:45`, "000"],
      ﾊﾞｲｸS: [`${D} 07:31:57`, "000"],
      住吉: [`${D} 10:12:34`, "000"],
    },
  },
  ...
  // A athlete who abandoned after 住吉
  {
    ...
    division: "Aタイプ",
    age: "40-44歳男子",
    waterEntry: `${D} 05:44:00`,
    start: `${D} 06:00:00`,
    passes: {
      ｽｲﾑF: [`${D} 07:30:00`, "000"],
      ﾊﾞｲｸS: [`${D} 07:38:00`, "000"],
      住吉: [`${D} 11:50:00`, "000"],
    },
    remark: "DNF/本部(20:24)",
  },
  // B finisher; note the B course has no swim lap and stops at ラン19km
  {
    ...
    division: "Bタイプ",
    age: "35-39歳男子",
    waterEntry: `${D} 07:10:00`,
    start: `${D} 07:30:00`,
    passes: {
      ｽｲﾑF: [`${D} 07:54:55`, "670"],
      ﾊﾞｲｸS: [`${D} 08:03:00`, "000"],
      住吉: [`${D} 08:47:00`, "000"],
      "ﾗﾝS（本部）": [`${D} 11:34:00`, "000"],
      ﾗﾝ4km: [`${D} 11:52:00`, "000"],
      ﾗﾝ19km: [`${D} 12:56:00`, "000"],
  ...
  // B athlete mid-run
  {
    ...
    division: "Bタイプ",
    age: "40-44歳女子",
    waterEntry: `${D} 07:12:00`,
    start: `${D} 07:30:00`,
    passes: {
      ｽｲﾑF: [`${D} 08:00:00`, "000"],
      ﾊﾞｲｸS: [`${D} 08:08:00`, "000"],
      住吉: [`${D} 08:55:00`, "000"],
      "ﾗﾝS（本部）": [`${D} 12:00:00`, "000"],
      ﾗﾝ4km: [`${D} 12:22:00`, "000"],
      ﾗﾝ14km: [`${D} 13:10:00`, "000"],
    },
  },
